...
function touchMove(e: TouchEvent) {
	// console.log(e)
	distance.value = e.changedTouches[0].clientY - initialTouch.value
...
<template>
	<div class="dev-page">
		<div class="info" :style="{transform: `translateY(${distance}px)`}">
			<div
				class="info-touch"
			...
			<div class="info-social">
				<div :class="['info-social-park', 'block', { hidden: hidden }]">
					<div :class="['park', { 'hidden-park': hidden }]">
						...
						<div class="text text-l">
							Центральный парк культуры и отдыха — это современное пространство
							с зонами отдыха, аттракционами и развлечениями для детей и
							взрослых. В парке есть более 40 аттракционов, в числе которых
							колесо обозрения, двухэтажная свадебная карусель, самый большой в
							России крытый автодром.<br />
							<br />
							В теплое время года в парке работает более 30 различных
							активностей: колесо обозрения, свадебная карусель, крытый
							автодром, спортивная зона и множество других аттракционов. Весной
							и осенью можно покататься на катамаранах в озере «Лагуна». Летом
							работает большой детский водоем, а зимой он превращается в
							открытый каток.<br />
							<br />
							...
							взрослых. Фестивали национальных культур, семейные праздники,
							квесты и многое другое.
						</div>
					</div>
				...
				<div class="info-social-vk block">
					<div :class="['title', { 'hidden-vk': hidden }]">
						Группа Вконтакте
					</div>
